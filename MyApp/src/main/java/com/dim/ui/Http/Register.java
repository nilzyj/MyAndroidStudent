...
//    public static String registerByPost(String name, String password) {
//        HttpURLConnection conn = null;
//        try {
//            //请求的地址，并创建URL对象
//            URL url = new URL("http://10.0.2.2:8080/Manage/test/RegisterServlet");
//            //打开连接
...
//
//            //传递的数据
//            String body = "username=" + URLEncoder.encode(name, "UTF-8") + "&pwd=" +
